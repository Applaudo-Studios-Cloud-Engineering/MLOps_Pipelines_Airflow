...
create_preprocessing = KubernetesPodOperator(dag=dag, 
    ...
    cmds=["python3", "-c"],
    arguments=["from pipelines.titanic import create_preprocessing_pipeline; create_preprocessing_pipeline('dags/repo/submodules/classification_projects/titanic_challenge/data/train.csv', True)"],
